...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de validación personalizados para atributos utilizando la convención "attribute.rule" para nombrar las líneas. Esto nos ayuda a especificar rápidamente un mensaje de idioma personalizado específico para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para cambiar nuestro marcador de posición de atributo, como "Dirección de correo electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
